export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#D0021B] p-4 md:p-0">
      <div className="w-full md:w-[1060px] flex flex-col md:flex-row items-center md:items-center justify-between px-6 md:px-[60px] py-8 md:py-10 gap-6 md:gap-10">
        ...
        {/* RIGHT */}
        <div className="w-full flex-1 flex flex-col items-center md:items-start gap-6 md:gap-7">
          ...
          <div className="flex flex-col gap-4 md:gap-[18px] w-full">
            ...
            <div className="flex items-center gap-3 md:gap-3.5 text-white text-sm md:text-base">
              <div className="w-9 h-9 md:w-[42px] md:h-[42px] border-2 border-white/55 rounded-full flex items-center justify-center shrink-0">
