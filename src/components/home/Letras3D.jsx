...
const items = [
  "Letreros luminosos",
  "Letreros 3D con iluminación led",
  "Backing con Iluminación led en 3D",
  "Letreros en altura",
];
...
export default function Letras3D() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const q = query(collection(db, "unopubli", "content", "galeria"), where("section", "==", "letras-3d"));
          ...
          <div className="lg:col-span-4">
            ...
            >
              <p className="text-uno-black font-bold text-lg md:text-xl italic mb-4">
                Corte digital de alta precisión y materiales de gran resistencia ideales para:
              </p>
              ...
              <div className="bg-uno-red/5 rounded-xl p-4 border-l-4 border-uno-red">
                <p className="text-uno-red font-bold text-sm italic">
                  Instalación profesional, en la altura que desees, nosotros llegamos.
                </p>
              </div>
            </motion.div>
          </div>
